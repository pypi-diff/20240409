# Comparing `tmp/unimpeded-0.2.1.tar.gz` & `tmp/unimpeded-0.2.2.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "unimpeded-0.2.1.tar", last modified: Tue Apr  9 18:20:14 2024, max compression
+gzip compressed data, was "unimpeded-0.2.2.tar", last modified: Tue Apr  9 18:32:48 2024, max compression
```

## Comparing `unimpeded-0.2.1.tar` & `unimpeded-0.2.2.tar`

### file list

```diff
@@ -1,17 +1,17 @@
-drwxr-xr-x   0 runner    (1001) docker     (127)        0 2024-04-09 18:20:14.355985 unimpeded-0.2.1/
--rw-r--r--   0 runner    (1001) docker     (127)     1069 2024-04-09 18:20:10.000000 unimpeded-0.2.1/LICENSE
--rw-r--r--   0 runner    (1001) docker     (127)     7077 2024-04-09 18:20:14.355985 unimpeded-0.2.1/PKG-INFO
--rw-r--r--   0 runner    (1001) docker     (127)     4203 2024-04-09 18:20:10.000000 unimpeded-0.2.1/README.rst
--rw-r--r--   0 runner    (1001) docker     (127)     1504 2024-04-09 18:20:10.000000 unimpeded-0.2.1/pyproject.toml
--rw-r--r--   0 runner    (1001) docker     (127)       94 2024-04-09 18:20:14.355985 unimpeded-0.2.1/setup.cfg
-drwxr-xr-x   0 runner    (1001) docker     (127)        0 2024-04-09 18:20:14.351985 unimpeded-0.2.1/tests/
--rw-r--r--   0 runner    (1001) docker     (127)       72 2024-04-09 18:20:10.000000 unimpeded-0.2.1/tests/test_init.py
-drwxr-xr-x   0 runner    (1001) docker     (127)        0 2024-04-09 18:20:14.355985 unimpeded-0.2.1/unimpeded/
--rw-r--r--   0 runner    (1001) docker     (127)      126 2024-04-09 18:20:10.000000 unimpeded-0.2.1/unimpeded/__init__.py
--rw-r--r--   0 runner    (1001) docker     (127)       22 2024-04-09 18:20:10.000000 unimpeded-0.2.1/unimpeded/_version.py
-drwxr-xr-x   0 runner    (1001) docker     (127)        0 2024-04-09 18:20:14.355985 unimpeded-0.2.1/unimpeded.egg-info/
--rw-r--r--   0 runner    (1001) docker     (127)     7077 2024-04-09 18:20:14.000000 unimpeded-0.2.1/unimpeded.egg-info/PKG-INFO
--rw-r--r--   0 runner    (1001) docker     (127)      270 2024-04-09 18:20:14.000000 unimpeded-0.2.1/unimpeded.egg-info/SOURCES.txt
--rw-r--r--   0 runner    (1001) docker     (127)        1 2024-04-09 18:20:14.000000 unimpeded-0.2.1/unimpeded.egg-info/dependency_links.txt
--rw-r--r--   0 runner    (1001) docker     (127)      126 2024-04-09 18:20:14.000000 unimpeded-0.2.1/unimpeded.egg-info/requires.txt
--rw-r--r--   0 runner    (1001) docker     (127)       10 2024-04-09 18:20:14.000000 unimpeded-0.2.1/unimpeded.egg-info/top_level.txt
...
### Comparing `unimpeded-0.2.1/LICENSE` & `unimpeded-0.2.2/LICENSE`

 * *Files identical despite different names*

### Comparing `unimpeded-0.2.1/PKG-INFO` & `unimpeded-0.2.2/PKG-INFO`
...
### Comparing `unimpeded-0.2.1/README.rst` & `unimpeded-0.2.2/README.rst`
...
### Comparing `unimpeded-0.2.1/pyproject.toml` & `unimpeded-0.2.2/pyproject.toml`

 * *Files identical despite different names*

### Comparing `unimpeded-0.2.1/unimpeded.egg-info/PKG-INFO` & `unimpeded-0.2.2/unimpeded.egg-info/PKG-INFO`
