# Comparing `tmp/cmdata-0.0.2.tar.gz` & `tmp/cmdata-1.0.0.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "/Users/rh/dev/cmdata/dist/.tmp-23ncs5p_/cmdata-0.0.2.tar", last modified: Tue Apr  9 14:29:10 2024, max compression
+gzip compressed data, was "cmdata-1.0.0.tar", last modified: Wed Dec 20 14:52:12 2023, max compression
```

## Comparing `cmdata-0.0.2.tar` & `cmdata-1.0.0.tar`

### file list

```diff
@@ -1,19 +1,19 @@
-drwxr-xr-x   0 rh         (501) staff       (20)        0 2024-04-09 14:29:10.211491 cmdata-0.0.2/
--rw-r--r--   0 rh         (501) staff       (20)     1087 2024-03-01 13:06:36.000000 cmdata-0.0.2/LICENSE
--rw-r--r--   0 rh         (501) staff       (20)    11073 2024-04-09 14:29:10.210952 cmdata-0.0.2/PKG-INFO
--rw-r--r--   0 rh         (501) staff       (20)     8688 2024-03-15 16:49:57.000000 cmdata-0.0.2/README.md
--rw-r--r--   0 rh         (501) staff       (20)     1421 2024-04-09 14:18:22.000000 cmdata-0.0.2/pyproject.toml
--rw-r--r--   0 rh         (501) staff       (20)       38 2024-04-09 14:29:10.211595 cmdata-0.0.2/setup.cfg
-drwxr-xr-x   0 rh         (501) staff       (20)        0 2024-04-09 14:29:10.202713 cmdata-0.0.2/src/
-drwxr-xr-x   0 rh         (501) staff       (20)        0 2024-04-09 14:29:10.205113 cmdata-0.0.2/src/cmdata/
--rw-r--r--   0 rh         (501) staff       (20)     1168 2024-03-01 13:06:36.000000 cmdata-0.0.2/src/cmdata/__init__.py
-drwxr-xr-x   0 rh         (501) staff       (20)        0 2024-04-09 14:29:10.207929 cmdata-0.0.2/src/cmdata/commodities/
--rw-r--r--   0 rh         (501) staff       (20)        0 2024-03-01 13:06:36.000000 cmdata-0.0.2/src/cmdata/commodities/__init__.py
--rw-r--r--   0 rh         (501) staff       (20)     9951 2024-03-15 16:49:57.000000 cmdata-0.0.2/src/cmdata/commodities/point_in_time.py
--rw-r--r--   0 rh         (501) staff       (20)      432 2024-03-01 13:06:36.000000 cmdata-0.0.2/src/cmdata/common.py
-drwxr-xr-x   0 rh         (501) staff       (20)        0 2024-04-09 14:29:10.208829 cmdata-0.0.2/src/cmdata.egg-info/
--rw-r--r--   0 rh         (501) staff       (20)    11073 2024-04-09 14:29:10.000000 cmdata-0.0.2/src/cmdata.egg-info/PKG-INFO
--rw-r--r--   0 rh         (501) staff       (20)      320 2024-04-09 14:29:10.000000 cmdata-0.0.2/src/cmdata.egg-info/SOURCES.txt
--rw-r--r--   0 rh         (501) staff       (20)        1 2024-04-09 14:29:10.000000 cmdata-0.0.2/src/cmdata.egg-info/dependency_links.txt
--rw-r--r--   0 rh         (501) staff       (20)       95 2024-04-09 14:29:10.000000 cmdata-0.0.2/src/cmdata.egg-info/requires.txt
--rw-r--r--   0 rh         (501) staff       (20)        7 2024-04-09 14:29:10.000000 cmdata-0.0.2/src/cmdata.egg-info/top_level.txt
...
### Comparing `cmdata-0.0.2/LICENSE` & `cmdata-1.0.0/LICENSE`

 * *Files identical despite different names*

### Comparing `cmdata-0.0.2/pyproject.toml` & `cmdata-1.0.0/pyproject.toml`
...
### Comparing `cmdata-0.0.2/src/cmdata/__init__.py` & `cmdata-1.0.0/src/cmdata/__init__.py`

 * *Files identical despite different names*

### Comparing `cmdata-0.0.2/src/cmdata/commodities/point_in_time.py` & `cmdata-1.0.0/src/cmdata/commodities/point_in_time.py`
