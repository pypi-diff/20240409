# Comparing `tmp/vantage6-node-4.3.4.tar.gz` & `tmp/vantage6-node-4.3.4rc3.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "vantage6-node-4.3.4.tar", last modified: Tue Apr  9 11:09:15 2024, max compression
+gzip compressed data, was "vantage6-node-4.3.4rc3.tar", last modified: Mon Mar 25 11:02:00 2024, max compression
```

## Comparing `vantage6-node-4.3.4.tar` & `vantage6-node-4.3.4rc3.tar`

### file list

```diff
@@ -1,37 +1,37 @@
-drwxr-xr-x   0 runner    (1001) docker     (127)        0 2024-04-09 11:09:15.197165 vantage6-node-4.3.4/
--rw-r--r--   0 runner    (1001) docker     (127)     9919 2024-04-09 11:09:15.197165 vantage6-node-4.3.4/PKG-INFO
--rw-r--r--   0 runner    (1001) docker     (127)       38 2024-04-09 11:09:15.197165 vantage6-node-4.3.4/setup.cfg
--rw-r--r--   0 runner    (1001) docker     (127)     1921 2024-04-09 11:09:01.000000 vantage6-node-4.3.4/setup.py
-drwxr-xr-x   0 runner    (1001) docker     (127)        0 2024-04-09 11:09:15.193165 vantage6-node-4.3.4/tests/
--rw-r--r--   0 runner    (1001) docker     (127)        0 2024-04-09 11:09:01.000000 vantage6-node-4.3.4/tests/__init__.py
--rw-r--r--   0 runner    (1001) docker     (127)        0 2024-04-09 11:09:01.000000 vantage6-node-4.3.4/tests/test_ssh_tunnel.py
-drwxr-xr-x   0 runner    (1001) docker     (127)        0 2024-04-09 11:09:15.189165 vantage6-node-4.3.4/vantage6/
-drwxr-xr-x   0 runner    (1001) docker     (127)        0 2024-04-09 11:09:15.193165 vantage6-node-4.3.4/vantage6/node/
--rw-r--r--   0 runner    (1001) docker     (127)        1 2024-04-09 11:09:01.000000 vantage6-node-4.3.4/vantage6/node/__build__
--rw-r--r--   0 runner    (1001) docker     (127)    41932 2024-04-09 11:09:01.000000 vantage6-node-4.3.4/vantage6/node/__init__.py
--rw-r--r--   0 runner    (1001) docker     (127)      747 2024-04-09 11:09:01.000000 vantage6-node-4.3.4/vantage6/node/_version.py
-drwxr-xr-x   0 runner    (1001) docker     (127)        0 2024-04-09 11:09:15.193165 vantage6-node-4.3.4/vantage6/node/cli/
--rw-r--r--   0 runner    (1001) docker     (127)        0 2024-04-09 11:09:01.000000 vantage6-node-4.3.4/vantage6/node/cli/__init__.py
--rw-r--r--   0 runner    (1001) docker     (127)     6988 2024-04-09 11:09:01.000000 vantage6-node-4.3.4/vantage6/node/cli/node.py
--rw-r--r--   0 runner    (1001) docker     (127)     2088 2024-04-09 11:09:01.000000 vantage6-node-4.3.4/vantage6/node/context.py
-drwxr-xr-x   0 runner    (1001) docker     (127)        0 2024-04-09 11:09:15.193165 vantage6-node-4.3.4/vantage6/node/docker/
--rw-r--r--   0 runner    (1001) docker     (127)     1434 2024-04-09 11:09:01.000000 vantage6-node-4.3.4/vantage6/node/docker/docker_base.py
--rw-r--r--   0 runner    (1001) docker     (127)    27826 2024-04-09 11:09:01.000000 vantage6-node-4.3.4/vantage6/node/docker/docker_manager.py
--rw-r--r--   0 runner    (1001) docker     (127)      604 2024-04-09 11:09:01.000000 vantage6-node-4.3.4/vantage6/node/docker/exceptions.py
--rw-r--r--   0 runner    (1001) docker     (127)     9146 2024-04-09 11:09:01.000000 vantage6-node-4.3.4/vantage6/node/docker/squid.py
--rw-r--r--   0 runner    (1001) docker     (127)     9601 2024-04-09 11:09:01.000000 vantage6-node-4.3.4/vantage6/node/docker/ssh_tunnel.py
--rw-r--r--   0 runner    (1001) docker     (127)    24489 2024-04-09 11:09:01.000000 vantage6-node-4.3.4/vantage6/node/docker/task_manager.py
--rw-r--r--   0 runner    (1001) docker     (127)    25549 2024-04-09 11:09:01.000000 vantage6-node-4.3.4/vantage6/node/docker/vpn_manager.py
--rw-r--r--   0 runner    (1001) docker     (127)     1517 2024-04-09 11:09:01.000000 vantage6-node-4.3.4/vantage6/node/globals.py
--rw-r--r--   0 runner    (1001) docker     (127)    11718 2024-04-09 11:09:01.000000 vantage6-node-4.3.4/vantage6/node/proxy_server.py
--rw-r--r--   0 runner    (1001) docker     (127)     6273 2024-04-09 11:09:01.000000 vantage6-node-4.3.4/vantage6/node/socket.py
-drwxr-xr-x   0 runner    (1001) docker     (127)        0 2024-04-09 11:09:15.193165 vantage6-node-4.3.4/vantage6/node/util/
--rw-r--r--   0 runner    (1001) docker     (127)      428 2024-04-09 11:09:01.000000 vantage6-node-4.3.4/vantage6/node/util/__init__.py
--rw-r--r--   0 runner    (1001) docker     (127)     3849 2024-04-09 11:09:01.000000 vantage6-node-4.3.4/vantage6/node/util/colorer.py
-drwxr-xr-x   0 runner    (1001) docker     (127)        0 2024-04-09 11:09:15.197165 vantage6-node-4.3.4/vantage6_node.egg-info/
--rw-r--r--   0 runner    (1001) docker     (127)     9919 2024-04-09 11:09:15.000000 vantage6-node-4.3.4/vantage6_node.egg-info/PKG-INFO
--rw-r--r--   0 runner    (1001) docker     (127)      820 2024-04-09 11:09:15.000000 vantage6-node-4.3.4/vantage6_node.egg-info/SOURCES.txt
--rw-r--r--   0 runner    (1001) docker     (127)        1 2024-04-09 11:09:15.000000 vantage6-node-4.3.4/vantage6_node.egg-info/dependency_links.txt
--rw-r--r--   0 runner    (1001) docker     (127)       64 2024-04-09 11:09:15.000000 vantage6-node-4.3.4/vantage6_node.egg-info/entry_points.txt
--rw-r--r--   0 runner    (1001) docker     (127)      292 2024-04-09 11:09:15.000000 vantage6-node-4.3.4/vantage6_node.egg-info/requires.txt
--rw-r--r--   0 runner    (1001) docker     (127)       15 2024-04-09 11:09:15.000000 vantage6-node-4.3.4/vantage6_node.egg-info/top_level.txt
...
### Comparing `vantage6-node-4.3.4/PKG-INFO` & `vantage6-node-4.3.4rc3/PKG-INFO`
...
```diff
@@ -1,9 +1,9 @@
-Metadata-Version: 2.1 Name: vantage6-node Version: 4.3.4 Summary: vantage6 node
...
### Comparing `vantage6-node-4.3.4/setup.py` & `vantage6-node-4.3.4rc3/setup.py`

 * *Files identical despite different names*

### Comparing `vantage6-node-4.3.4/vantage6/node/__init__.py` & `vantage6-node-4.3.4rc3/vantage6/node/__init__.py`
...
### Comparing `vantage6-node-4.3.4/vantage6/node/_version.py` & `vantage6-node-4.3.4rc3/vantage6/node/_version.py`
...
### Comparing `vantage6-node-4.3.4/vantage6/node/cli/node.py` & `vantage6-node-4.3.4rc3/vantage6/node/cli/node.py`

 * *Files identical despite different names*

### Comparing `vantage6-node-4.3.4/vantage6/node/context.py` & `vantage6-node-4.3.4rc3/vantage6/node/context.py`

 * *Files identical despite different names*

### Comparing `vantage6-node-4.3.4/vantage6/node/docker/docker_base.py` & `vantage6-node-4.3.4rc3/vantage6/node/docker/docker_base.py`

 * *Files identical despite different names*

### Comparing `vantage6-node-4.3.4/vantage6/node/docker/docker_manager.py` & `vantage6-node-4.3.4rc3/vantage6/node/docker/docker_manager.py`

 * *Files identical despite different names*

### Comparing `vantage6-node-4.3.4/vantage6/node/docker/exceptions.py` & `vantage6-node-4.3.4rc3/vantage6/node/docker/exceptions.py`

 * *Files identical despite different names*

### Comparing `vantage6-node-4.3.4/vantage6/node/docker/squid.py` & `vantage6-node-4.3.4rc3/vantage6/node/docker/squid.py`
...
### Comparing `vantage6-node-4.3.4/vantage6/node/docker/ssh_tunnel.py` & `vantage6-node-4.3.4rc3/vantage6/node/docker/ssh_tunnel.py`

 * *Files identical despite different names*

### Comparing `vantage6-node-4.3.4/vantage6/node/docker/task_manager.py` & `vantage6-node-4.3.4rc3/vantage6/node/docker/task_manager.py`
...
### Comparing `vantage6-node-4.3.4/vantage6/node/docker/vpn_manager.py` & `vantage6-node-4.3.4rc3/vantage6/node/docker/vpn_manager.py`
...
### Comparing `vantage6-node-4.3.4/vantage6/node/globals.py` & `vantage6-node-4.3.4rc3/vantage6/node/globals.py`

 * *Files identical despite different names*

### Comparing `vantage6-node-4.3.4/vantage6/node/proxy_server.py` & `vantage6-node-4.3.4rc3/vantage6/node/proxy_server.py`
...
### Comparing `vantage6-node-4.3.4/vantage6/node/socket.py` & `vantage6-node-4.3.4rc3/vantage6/node/socket.py`

 * *Files identical despite different names*

### Comparing `vantage6-node-4.3.4/vantage6/node/util/colorer.py` & `vantage6-node-4.3.4rc3/vantage6/node/util/colorer.py`

 * *Files identical despite different names*

### Comparing `vantage6-node-4.3.4/vantage6_node.egg-info/PKG-INFO` & `vantage6-node-4.3.4rc3/vantage6_node.egg-info/PKG-INFO`
...
### Comparing `vantage6-node-4.3.4/vantage6_node.egg-info/SOURCES.txt` & `vantage6-node-4.3.4rc3/vantage6_node.egg-info/SOURCES.txt`
