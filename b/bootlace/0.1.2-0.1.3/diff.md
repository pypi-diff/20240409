# Comparing `tmp/bootlace-0.1.2.tar.gz` & `tmp/bootlace-0.1.3.tar.gz`
...
### Comparing `bootlace-0.1.2/src/bootlace/testing/html.py` & `bootlace-0.1.3/src/bootlace/testing/html.py`
