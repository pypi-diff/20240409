# Comparing `tmp/anon_testo-0.3.0.tar.gz` & `tmp/anon_testo-0.5.0.tar.gz`
...
+gzip compressed data, was "anon_testo-0.5.0.tar", last modified: Tue Apr  9 16:09:32 2024, max compression
```

## Comparing `anon_testo-0.3.0.tar` & `anon_testo-0.5.0.tar`
...
+drwxrwxrwx   0        0        0        0 2024-04-09 16:09:32.588784 anon_testo-0.5.0/
+-rw-rw-rw-   0        0        0      906 2024-01-05 15:41:49.000000 anon_testo-0.5.0/LICENSE.md
+-rw-rw-rw-   0        0        0      722 2024-04-09 16:09:32.586760 anon_testo-0.5.0/PKG-INFO
+-rw-rw-rw-   0        0        0       71 2024-01-05 15:31:52.000000 anon_testo-0.5.0/README.md
+drwxrwxrwx   0        0        0        0 2024-04-09 16:09:32.569760 anon_testo-0.5.0/anon_testo/
+-rw-rw-rw-   0        0        0        0 2023-12-30 15:32:18.000000 anon_testo-0.5.0/anon_testo/__init__.py
+-rw-rw-rw-   0        0        0     7302 2024-04-09 15:04:16.000000 anon_testo-0.5.0/anon_testo/anon_testo.py
+-rw-rw-rw-   0        0        0     4805 2024-01-17 14:56:43.000000 anon_testo-0.5.0/anon_testo/it_fiscal_code_recognizer.py
+-rw-rw-rw-   0        0        0     3151 2024-01-17 14:56:43.000000 anon_testo-0.5.0/anon_testo/it_vat_code.py
+drwxrwxrwx   0        0        0        0 2024-04-09 16:09:32.585756 anon_testo-0.5.0/anon_testo.egg-info/
+-rw-rw-rw-   0        0        0      722 2024-04-09 16:09:32.000000 anon_testo-0.5.0/anon_testo.egg-info/PKG-INFO
+-rw-rw-rw-   0        0        0      312 2024-04-09 16:09:32.000000 anon_testo-0.5.0/anon_testo.egg-info/SOURCES.txt
+-rw-rw-rw-   0        0        0        1 2024-04-09 16:09:32.000000 anon_testo-0.5.0/anon_testo.egg-info/dependency_links.txt
+-rw-rw-rw-   0        0        0      114 2024-04-09 16:09:32.000000 anon_testo-0.5.0/anon_testo.egg-info/requires.txt
+-rw-rw-rw-   0        0        0       11 2024-04-09 16:09:32.000000 anon_testo-0.5.0/anon_testo.egg-info/top_level.txt
+-rw-rw-rw-   0        0        0       42 2024-04-09 16:09:32.589757 anon_testo-0.5.0/setup.cfg
+-rw-rw-rw-   0        0        0      897 2024-04-09 16:08:52.000000 anon_testo-0.5.0/setup.py
```

### Comparing `anon_testo-0.3.0/LICENSE.md` & `anon_testo-0.5.0/LICENSE.md`

 * *Files identical despite different names*

### Comparing `anon_testo-0.3.0/PKG-INFO` & `anon_testo-0.5.0/PKG-INFO`
...
### Comparing `anon_testo-0.3.0/anon_testo/anon_testo.py` & `anon_testo-0.5.0/anon_testo/anon_testo.py`
...
### Comparing `anon_testo-0.3.0/anon_testo/it_fiscal_code_recognizer.py` & `anon_testo-0.5.0/anon_testo/it_fiscal_code_recognizer.py`

 * *Files identical despite different names*

### Comparing `anon_testo-0.3.0/anon_testo/it_vat_code.py` & `anon_testo-0.5.0/anon_testo/it_vat_code.py`

 * *Files identical despite different names*

### Comparing `anon_testo-0.3.0/anon_testo.egg-info/PKG-INFO` & `anon_testo-0.5.0/anon_testo.egg-info/PKG-INFO`
...
### Comparing `anon_testo-0.3.0/setup.py` & `anon_testo-0.5.0/setup.py`
