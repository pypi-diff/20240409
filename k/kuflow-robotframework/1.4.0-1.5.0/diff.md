# Comparing `tmp/kuflow_robotframework-1.4.0.tar.gz` & `tmp/kuflow_robotframework-1.5.0.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "kuflow_robotframework-1.4.0.tar", max compression
+gzip compressed data, was "kuflow_robotframework-1.5.0.tar", max compression
```

## Comparing `kuflow_robotframework-1.4.0.tar` & `kuflow_robotframework-1.5.0.tar`

### file list

```diff
@@ -1,7 +1,7 @@
--rw-r--r--   0        0        0     1323 2024-03-15 12:57:18.583490 kuflow_robotframework-1.4.0/KuFlow/__init__.py
--rw-r--r--   0        0        0    19124 2024-03-15 12:57:18.583490 kuflow_robotframework-1.4.0/KuFlow/keywords.py
--rw-r--r--   0        0        0     2359 2024-03-15 12:57:18.583490 kuflow_robotframework-1.4.0/README.md
--rw-r--r--   0        0        0        6 2024-03-15 12:57:18.583490 kuflow_robotframework-1.4.0/VERSION
--rw-r--r--   0        0        0     1029 2024-03-15 12:58:22.232250 kuflow_robotframework-1.4.0/pyproject.toml
--rw-r--r--   0        0        0     3297 1970-01-01 00:00:00.000000 kuflow_robotframework-1.4.0/setup.py
--rw-r--r--   0        0        0     3288 1970-01-01 00:00:00.000000 kuflow_robotframework-1.4.0/PKG-INFO
...
### Comparing `kuflow_robotframework-1.4.0/KuFlow/__init__.py` & `kuflow_robotframework-1.5.0/KuFlow/__init__.py`
...
### Comparing `kuflow_robotframework-1.4.0/KuFlow/keywords.py` & `kuflow_robotframework-1.5.0/KuFlow/keywords.py`

 * *Files identical despite different names*

### Comparing `kuflow_robotframework-1.4.0/README.md` & `kuflow_robotframework-1.5.0/README.md`

 * *Files identical despite different names*

### Comparing `kuflow_robotframework-1.4.0/pyproject.toml` & `kuflow_robotframework-1.5.0/pyproject.toml`
...
### Comparing `kuflow_robotframework-1.4.0/setup.py` & `kuflow_robotframework-1.5.0/setup.py`
...
@@ -4,23 +4,23 @@
 ...
 install_requires = \
-['kuflow-rest>=1.4.0,<2.0.0', 'robotframework>5.0.0']
...
### Comparing `kuflow_robotframework-1.4.0/PKG-INFO` & `kuflow_robotframework-1.5.0/PKG-INFO`
