# Comparing `tmp/django_email_relay-0.4.1.tar.gz` & `tmp/django_email_relay-0.4.2.tar.gz`
...
### Comparing `django_email_relay-0.4.1/PKG-INFO` & `django_email_relay-0.4.2/PKG-INFO`
