# Comparing `tmp/BioSAK-1.82.0.tar.gz` & `tmp/BioSAK-1.82.1.tar.gz`
...
## Comparing `BioSAK-1.82.0.tar` & `BioSAK-1.82.1.tar`
...
### Comparing `BioSAK-1.82.0/BioSAK/BLCA_op_parser.py` & `BioSAK-1.82.1/BioSAK/BLCA_op_parser.py`

 * *Files identical despite different names*

### Comparing `BioSAK-1.82.0/BioSAK/BioSAK_config.py` & `BioSAK-1.82.1/BioSAK/BioSAK_config.py`

 * *Files identical despite different names*

### Comparing `BioSAK-1.82.0/BioSAK/COG2020.py` & `BioSAK-1.82.1/BioSAK/COG2020.py`

 * *Files identical despite different names*

### Comparing `BioSAK-1.82.0/BioSAK/COG_boxplot_last1row.R` & `BioSAK-1.82.1/BioSAK/COG_boxplot_last1row.R`

 * *Files identical despite different names*

### Comparing `BioSAK-1.82.0/BioSAK/COG_boxplot_last2row.R` & `BioSAK-1.82.1/BioSAK/COG_boxplot_last2row.R`

 * *Files identical despite different names*

### Comparing `BioSAK-1.82.0/BioSAK/CheckM.py` & `BioSAK-1.82.1/BioSAK/CheckM.py`

 * *Files identical despite different names*

### Comparing `BioSAK-1.82.0/BioSAK/ConvertMSA.py` & `BioSAK-1.82.1/BioSAK/ConvertMSA.py`

 * *Files identical despite different names*

### Comparing `BioSAK-1.82.0/BioSAK/DnaFeaturesViewer.py` & `BioSAK-1.82.1/BioSAK/DnaFeaturesViewer.py`

 * *Files identical despite different names*

### Comparing `BioSAK-1.82.0/BioSAK/FastaSplitler_by_num.py` & `BioSAK-1.82.1/BioSAK/FastaSplitler_by_num.py`

 * *Files identical despite different names*

### Comparing `BioSAK-1.82.0/BioSAK/FastaSplitler_by_size.py` & `BioSAK-1.82.1/BioSAK/FastaSplitler_by_size.py`

 * *Files identical despite different names*

### Comparing `BioSAK-1.82.0/BioSAK/GTDB_for_BLCA.py` & `BioSAK-1.82.1/BioSAK/GTDB_for_BLCA.py`

 * *Files identical despite different names*

### Comparing `BioSAK-1.82.0/BioSAK/Gene2Ctg.py` & `BioSAK-1.82.1/BioSAK/Gene2Ctg.py`

 * *Files identical despite different names*

### Comparing `BioSAK-1.82.0/BioSAK/KEGG.py` & `BioSAK-1.82.1/BioSAK/KEGG.py`

 * *Files identical despite different names*

### Comparing `BioSAK-1.82.0/BioSAK/KEGG_boxplot_last1row.R` & `BioSAK-1.82.1/BioSAK/KEGG_boxplot_last1row.R`

 * *Files identical despite different names*

### Comparing `BioSAK-1.82.0/BioSAK/KeepRemovingTmp.py` & `BioSAK-1.82.1/BioSAK/KeepRemovingTmp.py`

 * *Files identical despite different names*

### Comparing `BioSAK-1.82.0/BioSAK/MeanMappingDepth.py` & `BioSAK-1.82.1/BioSAK/MeanMappingDepth.py`

 * *Files identical despite different names*

### Comparing `BioSAK-1.82.0/BioSAK/MetaBiosample.py` & `BioSAK-1.82.1/BioSAK/MetaBiosample.py`

 * *Files identical despite different names*

### Comparing `BioSAK-1.82.0/BioSAK/MetaCHIP_phylo.hmm` & `BioSAK-1.82.1/BioSAK/MetaCHIP_phylo.hmm`

 * *Files identical despite different names*

### Comparing `BioSAK-1.82.0/BioSAK/MetaCyc_reactions_with_ec.txt` & `BioSAK-1.82.1/BioSAK/MetaCyc_reactions_with_ec.txt`

 * *Files identical despite different names*

### Comparing `BioSAK-1.82.0/BioSAK/NetEnzymes.py` & `BioSAK-1.82.1/BioSAK/NetEnzymes.py`

 * *Files identical despite different names*

### Comparing `BioSAK-1.82.0/BioSAK/Newick_tree_plotter.py` & `BioSAK-1.82.1/BioSAK/Newick_tree_plotter.py`

 * *Files identical despite different names*

### Comparing `BioSAK-1.82.0/BioSAK/OneLineAln.py` & `BioSAK-1.82.1/BioSAK/OneLineAln.py`

 * *Files identical despite different names*

### Comparing `BioSAK-1.82.0/BioSAK/Prodigal.py` & `BioSAK-1.82.1/BioSAK/Prodigal.py`

 * *Files identical despite different names*

### Comparing `BioSAK-1.82.0/BioSAK/Reads_simulator.py` & `BioSAK-1.82.1/BioSAK/Reads_simulator.py`

 * *Files identical despite different names*

### Comparing `BioSAK-1.82.0/BioSAK/RunGraphMB.py` & `BioSAK-1.82.1/BioSAK/RunGraphMB.py`

 * *Files identical despite different names*

### Comparing `BioSAK-1.82.0/BioSAK/SILVA_for_BLCA.py` & `BioSAK-1.82.1/BioSAK/SILVA_for_BLCA.py`

 * *Files identical despite different names*

### Comparing `BioSAK-1.82.0/BioSAK/SankeyTaxon.py` & `BioSAK-1.82.1/BioSAK/SankeyTaxon.py`

 * *Files identical despite different names*

### Comparing `BioSAK-1.82.0/BioSAK/SliceMSA.py` & `BioSAK-1.82.1/BioSAK/SliceMSA.py`

 * *Files identical despite different names*

### Comparing `BioSAK-1.82.0/BioSAK/SubsampleLongReads.py` & `BioSAK-1.82.1/BioSAK/SubsampleLongReads.py`

 * *Files identical despite different names*

### Comparing `BioSAK-1.82.0/BioSAK/Tax4Fun2IndOTU.py` & `BioSAK-1.82.1/BioSAK/Tax4Fun2IndOTU.py`

 * *Files identical despite different names*

### Comparing `BioSAK-1.82.0/BioSAK/VERSION` & `BioSAK-1.82.1/BioSAK/VERSION`
...
-
 ...
 1.80.0
 - new module added: add_desc
 
 1.79.0
```

### Comparing `BioSAK-1.82.0/BioSAK/VisGeneFlk.py` & `BioSAK-1.82.1/BioSAK/VisGeneFlk.py`

 * *Files identical despite different names*

### Comparing `BioSAK-1.82.0/BioSAK/add_desc.py` & `BioSAK-1.82.1/BioSAK/add_desc.py`

 * *Files identical despite different names*

### Comparing `BioSAK-1.82.0/BioSAK/arCOG.py` & `BioSAK-1.82.1/BioSAK/arCOG.py`

 * *Files identical despite different names*

### Comparing `BioSAK-1.82.0/BioSAK/bam2reads.py` & `BioSAK-1.82.1/BioSAK/bam2reads.py`

 * *Files identical despite different names*

### Comparing `BioSAK-1.82.0/BioSAK/boxplot.py` & `BioSAK-1.82.1/BioSAK/boxplot.py`

 * *Files identical despite different names*

### Comparing `BioSAK-1.82.0/BioSAK/boxplot_last1row.R` & `BioSAK-1.82.1/BioSAK/boxplot_last1row.R`

 * *Files identical despite different names*

### Comparing `BioSAK-1.82.0/BioSAK/boxplot_matrix_COG.py` & `BioSAK-1.82.1/BioSAK/boxplot_matrix_COG.py`

 * *Files identical despite different names*

### Comparing `BioSAK-1.82.0/BioSAK/boxplot_matrix_COG_backup.py` & `BioSAK-1.82.1/BioSAK/boxplot_matrix_COG_backup.py`

 * *Files identical despite different names*

### Comparing `BioSAK-1.82.0/BioSAK/boxplot_matrix_KEGG.py` & `BioSAK-1.82.1/BioSAK/boxplot_matrix_KEGG.py`

 * *Files identical despite different names*

### Comparing `BioSAK-1.82.0/BioSAK/boxplot_matrix_dbCAN.py` & `BioSAK-1.82.1/BioSAK/boxplot_matrix_dbCAN.py`

 * *Files identical despite different names*

### Comparing `BioSAK-1.82.0/BioSAK/cat_fa.py` & `BioSAK-1.82.1/BioSAK/cat_fa.py`

 * *Files identical despite different names*

### Comparing `BioSAK-1.82.0/BioSAK/cdd2cog.pl` & `BioSAK-1.82.1/BioSAK/cdd2cog.pl`

 * *Files identical despite different names*

### Comparing `BioSAK-1.82.0/BioSAK/checkm_marker.py` & `BioSAK-1.82.1/BioSAK/checkm_marker.py`

 * *Files identical despite different names*

### Comparing `BioSAK-1.82.0/BioSAK/compare_trees.R` & `BioSAK-1.82.1/BioSAK/compare_trees.R`

 * *Files identical despite different names*

### Comparing `BioSAK-1.82.0/BioSAK/compare_trees.py` & `BioSAK-1.82.1/BioSAK/compare_trees.py`

 * *Files identical despite different names*

### Comparing `BioSAK-1.82.0/BioSAK/cross_link_seqs.py` & `BioSAK-1.82.1/BioSAK/cross_link_seqs.py`

 * *Files identical despite different names*

### Comparing `BioSAK-1.82.0/BioSAK/dbCAN.py` & `BioSAK-1.82.1/BioSAK/dbCAN.py`

 * *Files identical despite different names*

### Comparing `BioSAK-1.82.0/BioSAK/download_GenBank_genome_subset_prokaryotes_csv.py` & `BioSAK-1.82.1/BioSAK/download_GenBank_genome_subset_prokaryotes_csv.py`

 * *Files identical despite different names*

### Comparing `BioSAK-1.82.0/BioSAK/dwnld_sra_reads.py` & `BioSAK-1.82.1/BioSAK/dwnld_sra_reads.py`

 * *Files identical despite different names*

### Comparing `BioSAK-1.82.0/BioSAK/enrich.py` & `BioSAK-1.82.1/BioSAK/enrich.py`

 * *Files identical despite different names*

### Comparing `BioSAK-1.82.0/BioSAK/exe_cmds.py` & `BioSAK-1.82.1/BioSAK/exe_cmds.py`

 * *Files identical despite different names*

### Comparing `BioSAK-1.82.0/BioSAK/ezaai2mat.py` & `BioSAK-1.82.1/BioSAK/ezaai2mat.py`

 * *Files identical despite different names*

### Comparing `BioSAK-1.82.0/BioSAK/fa2id.py` & `BioSAK-1.82.1/BioSAK/fa2id.py`

 * *Files identical despite different names*

### Comparing `BioSAK-1.82.0/BioSAK/fa2phy.py` & `BioSAK-1.82.1/BioSAK/fa2phy.py`

 * *Files identical despite different names*

### Comparing `BioSAK-1.82.0/BioSAK/fa2tree.py` & `BioSAK-1.82.1/BioSAK/fa2tree.py`

 * *Files identical despite different names*

### Comparing `BioSAK-1.82.0/BioSAK/format_converter.py` & `BioSAK-1.82.1/BioSAK/format_converter.py`

 * *Files identical despite different names*

### Comparing `BioSAK-1.82.0/BioSAK/format_leaf_name.py` & `BioSAK-1.82.1/BioSAK/format_leaf_name.py`

 * *Files identical despite different names*

### Comparing `BioSAK-1.82.0/BioSAK/fq2fa.py` & `BioSAK-1.82.1/BioSAK/fq2fa.py`

 * *Files identical despite different names*

### Comparing `BioSAK-1.82.0/BioSAK/gapseq.py` & `BioSAK-1.82.1/BioSAK/gapseq.py`
...
### Comparing `BioSAK-1.82.0/BioSAK/gbk2faa.py` & `BioSAK-1.82.1/BioSAK/gbk2faa.py`

 * *Files identical despite different names*

### Comparing `BioSAK-1.82.0/BioSAK/gbk2ffn.py` & `BioSAK-1.82.1/BioSAK/gbk2ffn.py`

 * *Files identical despite different names*

### Comparing `BioSAK-1.82.0/BioSAK/gbk2fna.py` & `BioSAK-1.82.1/BioSAK/gbk2fna.py`

 * *Files identical despite different names*

### Comparing `BioSAK-1.82.0/BioSAK/gbk_to_ffn_faa.py` & `BioSAK-1.82.1/BioSAK/gbk_to_ffn_faa.py`

 * *Files identical despite different names*

### Comparing `BioSAK-1.82.0/BioSAK/get_EC_from_ko_stats_D.py` & `BioSAK-1.82.1/BioSAK/get_EC_from_ko_stats_D.py`

 * *Files identical despite different names*

### Comparing `BioSAK-1.82.0/BioSAK/get_GTDB_taxon_gnm.py` & `BioSAK-1.82.1/BioSAK/get_GTDB_taxon_gnm.py`

 * *Files identical despite different names*

### Comparing `BioSAK-1.82.0/BioSAK/get_MAG_reads_long.py` & `BioSAK-1.82.1/BioSAK/get_MAG_reads_long.py`

 * *Files identical despite different names*

### Comparing `BioSAK-1.82.0/BioSAK/get_Pfam_hmms.py` & `BioSAK-1.82.1/BioSAK/get_Pfam_hmms.py`

 * *Files identical despite different names*

### Comparing `BioSAK-1.82.0/BioSAK/get_SCG_tree.py` & `BioSAK-1.82.1/BioSAK/get_SCG_tree.py`

 * *Files identical despite different names*

### Comparing `BioSAK-1.82.0/BioSAK/get_TopHits_taxonomy.py` & `BioSAK-1.82.1/BioSAK/get_TopHits_taxonomy.py`

 * *Files identical despite different names*

### Comparing `BioSAK-1.82.0/BioSAK/get_aa_composition.py` & `BioSAK-1.82.1/BioSAK/get_aa_composition.py`

 * *Files identical despite different names*

### Comparing `BioSAK-1.82.0/BioSAK/get_bin_abundance copy.py` & `BioSAK-1.82.1/BioSAK/get_bin_abundance copy.py`

 * *Files identical despite different names*

### Comparing `BioSAK-1.82.0/BioSAK/get_data_matrix.py` & `BioSAK-1.82.1/BioSAK/get_data_matrix.py`

 * *Files identical despite different names*

### Comparing `BioSAK-1.82.0/BioSAK/get_gc.py` & `BioSAK-1.82.1/BioSAK/get_gc.py`

 * *Files identical despite different names*

### Comparing `BioSAK-1.82.0/BioSAK/get_gene_depth.py` & `BioSAK-1.82.1/BioSAK/get_gene_depth.py`

 * *Files identical despite different names*

### Comparing `BioSAK-1.82.0/BioSAK/get_genome_GTDB.py` & `BioSAK-1.82.1/BioSAK/get_genome_GTDB.py`

 * *Files identical despite different names*

### Comparing `BioSAK-1.82.0/BioSAK/get_genome_NCBI.py` & `BioSAK-1.82.1/BioSAK/get_genome_NCBI.py`

 * *Files identical despite different names*

### Comparing `BioSAK-1.82.0/BioSAK/get_genome_NCBI_v1.py` & `BioSAK-1.82.1/BioSAK/get_genome_NCBI_v1.py`

 * *Files identical despite different names*

### Comparing `BioSAK-1.82.0/BioSAK/get_genome_NCBI_v2.py` & `BioSAK-1.82.1/BioSAK/get_genome_NCBI_v2.py`

 * *Files identical despite different names*

### Comparing `BioSAK-1.82.0/BioSAK/get_gnm_size.py` & `BioSAK-1.82.1/BioSAK/get_gnm_size.py`

 * *Files identical despite different names*

### Comparing `BioSAK-1.82.0/BioSAK/get_ko_gene_seqs.py` & `BioSAK-1.82.1/BioSAK/get_ko_gene_seqs.py`

 * *Files identical despite different names*

### Comparing `BioSAK-1.82.0/BioSAK/get_krona_plot.py` & `BioSAK-1.82.1/BioSAK/get_krona_plot.py`

 * *Files identical despite different names*

### Comparing `BioSAK-1.82.0/BioSAK/get_reads_from_sam.py` & `BioSAK-1.82.1/BioSAK/get_reads_from_sam.py`

 * *Files identical despite different names*

### Comparing `BioSAK-1.82.0/BioSAK/get_reads_id_in_sam.py` & `BioSAK-1.82.1/BioSAK/get_reads_id_in_sam.py`

 * *Files identical despite different names*

### Comparing `BioSAK-1.82.0/BioSAK/get_sankey_plot.R` & `BioSAK-1.82.1/BioSAK/get_sankey_plot.R`

 * *Files identical despite different names*

### Comparing `BioSAK-1.82.0/BioSAK/get_top_hit.py` & `BioSAK-1.82.1/BioSAK/get_top_hit.py`

 * *Files identical despite different names*

### Comparing `BioSAK-1.82.0/BioSAK/get_total_length.py` & `BioSAK-1.82.1/BioSAK/get_total_length.py`

 * *Files identical despite different names*

### Comparing `BioSAK-1.82.0/BioSAK/global_functions.py` & `BioSAK-1.82.1/BioSAK/global_functions.py`

 * *Files identical despite different names*

### Comparing `BioSAK-1.82.0/BioSAK/hpc3.py` & `BioSAK-1.82.1/BioSAK/hpc3.py`

 * *Files identical despite different names*

### Comparing `BioSAK-1.82.0/BioSAK/iTOL.py` & `BioSAK-1.82.1/BioSAK/iTOL.py`

 * *Files identical despite different names*

### Comparing `BioSAK-1.82.0/BioSAK/js_cmds.py` & `BioSAK-1.82.1/BioSAK/js_cmds.py`

 * *Files identical despite different names*

### Comparing `BioSAK-1.82.0/BioSAK/js_hpc3.py` & `BioSAK-1.82.1/BioSAK/js_hpc3.py`

 * *Files identical despite different names*

### Comparing `BioSAK-1.82.0/BioSAK/keep_best_hit.py` & `BioSAK-1.82.1/BioSAK/keep_best_hit.py`

 * *Files identical despite different names*

### Comparing `BioSAK-1.82.0/BioSAK/ko00001.keg` & `BioSAK-1.82.1/BioSAK/ko00001.keg`

 * *Files identical despite different names*

### Comparing `BioSAK-1.82.0/BioSAK/koala.py` & `BioSAK-1.82.1/BioSAK/koala.py`

 * *Files identical despite different names*

### Comparing `BioSAK-1.82.0/BioSAK/label_tree.R` & `BioSAK-1.82.1/BioSAK/label_tree.R`

 * *Files identical despite different names*

### Comparing `BioSAK-1.82.0/BioSAK/label_tree.py` & `BioSAK-1.82.1/BioSAK/label_tree.py`

 * *Files identical despite different names*

### Comparing `BioSAK-1.82.0/BioSAK/link_16S_MAG.py` & `BioSAK-1.82.1/BioSAK/link_16S_MAG.py`

 * *Files identical despite different names*

### Comparing `BioSAK-1.82.0/BioSAK/magabund.py` & `BioSAK-1.82.1/BioSAK/magabund.py`

 * *Files identical despite different names*

### Comparing `BioSAK-1.82.0/BioSAK/magabund2.py` & `BioSAK-1.82.1/BioSAK/magabund2.py`

 * *Files identical despite different names*

### Comparing `BioSAK-1.82.0/BioSAK/manipulator_fasta.py` & `BioSAK-1.82.1/BioSAK/manipulator_fasta.py`

 * *Files identical despite different names*

### Comparing `BioSAK-1.82.0/BioSAK/manipulator_newick.py` & `BioSAK-1.82.1/BioSAK/manipulator_newick.py`

 * *Files identical despite different names*

### Comparing `BioSAK-1.82.0/BioSAK/mean_MAG_cov.py` & `BioSAK-1.82.1/BioSAK/mean_MAG_cov.py`

 * *Files identical despite different names*

### Comparing `BioSAK-1.82.0/BioSAK/merge_df.py` & `BioSAK-1.82.1/BioSAK/merge_df.py`

 * *Files identical despite different names*

### Comparing `BioSAK-1.82.0/BioSAK/merge_seq.py` & `BioSAK-1.82.1/BioSAK/merge_seq.py`

 * *Files identical despite different names*

### Comparing `BioSAK-1.82.0/BioSAK/metaAssembly.py` & `BioSAK-1.82.1/BioSAK/metaAssembly.py`

 * *Files identical despite different names*

### Comparing `BioSAK-1.82.0/BioSAK/metabat2concoct.py` & `BioSAK-1.82.1/BioSAK/metabat2concoct.py`

 * *Files identical despite different names*

### Comparing `BioSAK-1.82.0/BioSAK/metabat2maxbin.py` & `BioSAK-1.82.1/BioSAK/metabat2maxbin.py`

 * *Files identical despite different names*

### Comparing `BioSAK-1.82.0/BioSAK/ncbi_dataset.py` & `BioSAK-1.82.1/BioSAK/ncbi_dataset.py`

 * *Files identical despite different names*

### Comparing `BioSAK-1.82.0/BioSAK/parse_MetaCyc_RxnDB.py` & `BioSAK-1.82.1/BioSAK/parse_MetaCyc_RxnDB.py`

 * *Files identical despite different names*

### Comparing `BioSAK-1.82.0/BioSAK/parse_mmseqs_tsv.py` & `BioSAK-1.82.1/BioSAK/parse_mmseqs_tsv.py`

 * *Files identical despite different names*

### Comparing `BioSAK-1.82.0/BioSAK/plot_mag.py` & `BioSAK-1.82.1/BioSAK/plot_mag.py`

 * *Files identical despite different names*

### Comparing `BioSAK-1.82.0/BioSAK/plot_sam_depth.py` & `BioSAK-1.82.1/BioSAK/plot_sam_depth.py`

 * *Files identical despite different names*

### Comparing `BioSAK-1.82.0/BioSAK/plot_tree.R` & `BioSAK-1.82.1/BioSAK/plot_tree.R`

 * *Files identical despite different names*

### Comparing `BioSAK-1.82.0/BioSAK/prefix_file.py` & `BioSAK-1.82.1/BioSAK/prefix_file.py`

 * *Files identical despite different names*

### Comparing `BioSAK-1.82.0/BioSAK/prokka.py` & `BioSAK-1.82.1/BioSAK/prokka.py`

 * *Files identical despite different names*

### Comparing `BioSAK-1.82.0/BioSAK/reads2bam.py` & `BioSAK-1.82.1/BioSAK/reads2bam.py`

 * *Files identical despite different names*

### Comparing `BioSAK-1.82.0/BioSAK/rename_leaves.py` & `BioSAK-1.82.1/BioSAK/rename_leaves.py`

 * *Files identical despite different names*

### Comparing `BioSAK-1.82.0/BioSAK/rename_reads_for_Reago.py` & `BioSAK-1.82.1/BioSAK/rename_reads_for_Reago.py`

 * *Files identical despite different names*

### Comparing `BioSAK-1.82.0/BioSAK/rename_seq.py` & `BioSAK-1.82.1/BioSAK/rename_seq.py`

 * *Files identical despite different names*

### Comparing `BioSAK-1.82.0/BioSAK/rename_seqs.py` & `BioSAK-1.82.1/BioSAK/rename_seqs.py`

 * *Files identical despite different names*

### Comparing `BioSAK-1.82.0/BioSAK/sam2bam.py` & `BioSAK-1.82.1/BioSAK/sam2bam.py`

 * *Files identical despite different names*

### Comparing `BioSAK-1.82.0/BioSAK/sampling_GTDB_gnms.py` & `BioSAK-1.82.1/BioSAK/sampling_GTDB_gnms.py`

 * *Files identical despite different names*

### Comparing `BioSAK-1.82.0/BioSAK/select_seq.py` & `BioSAK-1.82.1/BioSAK/select_seq.py`

 * *Files identical despite different names*

### Comparing `BioSAK-1.82.0/BioSAK/sep_reads_by_barcode.py` & `BioSAK-1.82.1/BioSAK/sep_reads_by_barcode.py`

 * *Files identical despite different names*

### Comparing `BioSAK-1.82.0/BioSAK/slice_seq.py` & `BioSAK-1.82.1/BioSAK/slice_seq.py`

 * *Files identical despite different names*

### Comparing `BioSAK-1.82.0/BioSAK/split_fasta.py` & `BioSAK-1.82.1/BioSAK/split_fasta.py`

 * *Files identical despite different names*

### Comparing `BioSAK-1.82.0/BioSAK/split_folder.py` & `BioSAK-1.82.1/BioSAK/split_folder.py`

 * *Files identical despite different names*

### Comparing `BioSAK-1.82.0/BioSAK/split_sam.py` & `BioSAK-1.82.1/BioSAK/split_sam.py`

 * *Files identical despite different names*

### Comparing `BioSAK-1.82.0/BioSAK/submitHPC.py` & `BioSAK-1.82.1/BioSAK/submitHPC.py`

 * *Files identical despite different names*

### Comparing `BioSAK-1.82.0/BioSAK/subset_GTDB_meta.py` & `BioSAK-1.82.1/BioSAK/subset_GTDB_meta.py`

 * *Files identical despite different names*

### Comparing `BioSAK-1.82.0/BioSAK/subset_df.py` & `BioSAK-1.82.1/BioSAK/subset_df.py`

 * *Files identical despite different names*

### Comparing `BioSAK-1.82.0/BioSAK/subset_tree.py` & `BioSAK-1.82.1/BioSAK/subset_tree.py`

 * *Files identical despite different names*

### Comparing `BioSAK-1.82.0/BioSAK/top_16S_hits.py` & `BioSAK-1.82.1/BioSAK/top_16S_hits.py`

 * *Files identical despite different names*

### Comparing `BioSAK-1.82.0/BioSAK/top_hits_in_a_group.py` & `BioSAK-1.82.1/BioSAK/top_hits_in_a_group.py`

 * *Files identical despite different names*

### Comparing `BioSAK-1.82.0/BioSAK/usearch_uc.py` & `BioSAK-1.82.1/BioSAK/usearch_uc.py`

 * *Files identical despite different names*

### Comparing `BioSAK-1.82.0/BioSAK.egg-info/SOURCES.txt` & `BioSAK-1.82.1/BioSAK.egg-info/SOURCES.txt`

 * *Files identical despite different names*

### Comparing `BioSAK-1.82.0/LICENSE` & `BioSAK-1.82.1/LICENSE`

 * *Files identical despite different names*

### Comparing `BioSAK-1.82.0/README.md` & `BioSAK-1.82.1/README.md`

 * *Files identical despite different names*

### Comparing `BioSAK-1.82.0/bin/BioSAK` & `BioSAK-1.82.1/bin/BioSAK`

 * *Files identical despite different names*

### Comparing `BioSAK-1.82.0/setup.py` & `BioSAK-1.82.1/setup.py`
